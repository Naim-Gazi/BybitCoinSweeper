...
if __name__ == "__main__":
    banner_text = "GN SCRIPTS"  # Modified banner text
    os.system('cls' if os.name == 'nt' else 'clear')
    create_gradient_banner(banner_text)
    
    # Updated social media usernames
    social_media_usernames = [
        ("Author", "NaimGazi TG @BLUMSCRIPTS"),
        ("Telegram", "https://t.me/GN_SCRIPTS"),
        ("YouTube", "https://www.youtube.com/@GyaaniNaim"),
    ]
    ...
    for i in range(int(tm)):
        ...
        create_gradient_banner('WARK DONE')
